            ...
            <div class="modal-body">
                <form id="notificationForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="comment4" name="comment4" rows="3"><?php echo htmlspecialchars("Hearing Date ".$complaint_list[0]['hearing_date']." | Hearing Time ".$complaint_list[0]['hearing_time']." | Hearing Location ".$complaint_list[0]['hearing_location']); ?></textarea>
                    </div>
