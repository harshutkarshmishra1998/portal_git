...
<body>
    ...
    <div class="content" id="mainContent">
        ...
        <?php if (!empty($complaint_list)): ?>
                ...
                <div class="card-body">
                    ...
                    <div id="complaintDetails" class="collapse">
                        ...
                        <div class="d-flex gap-2 mt-3">
                            <a href="../file/fileView.php?ref_id=<?= urlencode($complaint_list[0]['reference_id']) ?>&status=<?= urlencode($complaint_list[0]['status']) ?>" class="btn btn-success" target="_blank">View Uploaded Files</a>
            ...
            <?php include 'statusTableComplaint.php'; ?>
