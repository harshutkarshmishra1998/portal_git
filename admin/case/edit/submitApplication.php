...
try {
    ...
    $stmtStatus = $pdo->prepare("INSERT INTO case_status (reference_id, status, comment, editor_name, editor_email, editor_mobile) VALUES (:reference_id, :status, 'Application Edited by Admin', :editor_name, :editor_email, :editor_mobile)");
