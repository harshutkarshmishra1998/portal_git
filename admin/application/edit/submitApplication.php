...
try {
    ...
    $stmtStatus = $pdo->prepare("INSERT INTO application_status (reference_id, status, comment, editor_name, editor_email, editor_mobile) VALUES (:reference_id, 'Pending', 'Application Edited by Admin', :editor_name, :editor_email, :editor_mobile)");
