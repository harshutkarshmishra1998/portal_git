    ...
    <div class="content" id="mainContent">
        ...
        <form id="memberForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="wardNumber" name="wardNumber" value="<?php echo htmlspecialchars($wardNumber); ?>" required>
            </div>
            <div class="mb-3">
                <label for="role" class="form-label">Role</label>
                <select class="form-select" id="role" name="role" required>
                    <option value="ward_member" <?php if ($role === 'ward_member') echo 'selected'; ?>>Ward Member</option>
                    <option value="case_handler" <?php if ($role === 'case_handler') echo 'selected'; ?>>Case Handler</option>
                    <option value="both" <?php if ($role === 'both') echo 'selected'; ?>>Both</option>
                </select>
            </div>
            <div class="mb-3">
