    ...
    <div class="container">
        ...
        <form id="applicationForm" action="/submit" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="शीर्षक प्रविष्ट गर्नुहोस्" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="type" name="type" required>
                    ...
                    <option value="वरिष्ठ नागरिकहरूलाई हेरचाह र सहयोग नदिने">वरिष्ठ नागरिकहरूलाई हेरचाह र सहयोग नदिने</option>
                    ...
                    <option value="इट्टा, टाइल वा छानो निर्माण मापदण्ड अनुसार नराख्ने">इट्टा, टाइल वा छानो निर्माण मापदण्ड अनुसार नराख्ने</option>
                    <option value="आसपासको वातावरणमा असर पुर्याउने रूख रोपण">आसपासको वातावरणमा असर पुर्याउने रूख रोपण</option>
                    <option value="सार्वजनिक भू-भूमि/मार्ग प्रयोगको अधिकार">सार्वजनिक भू-भूमि/मार्ग प्रयोगको अधिकार</option>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="plantiff_address" name="plantiff_address" rows="2" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" pattern="\d{10}" class="form-control" id="plantiff_mobile"
                                name="plantiff_mobile" placeholder="मोबाइल नम्बर प्रविष्ट गर्नुहोस् (+977 बिना)" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="email" class="form-control" id="plantiff_email" name="plantiff_email" placeholder="इमेल प्रविष्ट गर्नुहोस्" required>
                            <div class="input-group-append">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="plantiff_citizenship" name="plantiff_citizenship" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="defendant_address" name="defendant_address" rows="2" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" pattern="\d{10}" class="form-control" id="defendant_mobile" name="defendant_mobile" placeholder="मोबाइल नम्बर प्रविष्ट गर्नुहोस् (+977 बिना)" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="defendant_grandfather_name" name="defendant_grandfather_name" required>
                    </div>
                    <!-- Defendant Citizenship Proof Upload -->
                    <div class="form-group">
                        <label for="defendant_citizenship">प्रतिवादीको नागरिकता प्रमाण</label>
                        <input type="file" class="form-control-file" id="defendant_citizenship" name="defendant_citizenship" required>
