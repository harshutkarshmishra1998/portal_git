        ...
        <form id="applicationForm" action="/submit" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="type" name="type" required>
                    ...
                    <option value="पति-पत्नी सम्बन्धको समस्या">पति-पत्नी सम्बन्धको समस्या</option>
                    ...
                    <option value="वरिष्ठ नागरिकलाई हेरचाह र सहयोग नदिने">वरिष्ठ नागरिकलाई हेरचाह र सहयोग नदिने</option>
                    ...
                    <option value="इट्टा, टाइल वा छाना निर्माण मानक अनुसार नराख्ने">इट्टा, टाइल वा छाना निर्माण मानक
                        अनुसार नराख्ने</option>
                    <option value="आसपासको वातावरणमा असर गर्ने रूख रोपण">आसपासको वातावरणमा असर गर्ने रूख रोपण</option>
                    <option value="सार्वजनिक भू-भूमि/मार्ग प्रयोगको अधिकार">सार्वजनिक भू-भूमि/मार्ग प्रयोगको अधिकार
                    </option>
                    <option value="निर्माणलाई मानक विरुद्ध रोक्ने">निर्माणलाई मानक विरुद्ध रोक्ने</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" pattern="\d{10}" class="form-control" id="plantiff_mobile"
                            name="plantiff_mobile" placeholder="10-अंकीय मोबाइल नम्बर" readonly>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" pattern="\d{10}" class="form-control" id="defendant_mobile"
                            name="defendant_mobile" placeholder="10-अंकीय मोबाइल नम्बर">
                    </div>
                    <div class="form-group">
