...
if (file_exists($pathToHashRefId)) {
    ...
    if (function_exists('unhashedReferenceID')) {
        ...
        if (isset($_POST['ref_id'])) {
            ...
            global $hasher;
            if (isset($hasher)) {
                $hashedId = unhashedReferenceID($refId);
        ...
        echo json_encode(['error' => 'unhashedReferenceID function not found. Ensure hashRefId.php is included correctly.']);
    }
} else {
