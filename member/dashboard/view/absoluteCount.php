...
$sql = "SELECT COUNT(*) AS total_complaints
FROM application
WHERE plantiff_ward_number = $ward_number";
...
INNER JOIN application a ON a.reference_id = cs.reference_id
WHERE a.plantiff_ward_number = $ward_number";
